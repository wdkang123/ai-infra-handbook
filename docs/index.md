...
如果你准备发布到 GitHub 或部署在线站点，再看 [公开发布总览](/08-publication/00-overview)、[GitHub Pages 发布指南](/08-publication/01-github-pages) 和 [GitHub 仓库设置建议](/08-publication/04-repository-settings)。
