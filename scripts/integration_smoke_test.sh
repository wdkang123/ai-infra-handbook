...
check_code "IT-01 gateway proxy" "200" "curl -s -o /dev/null -w '%{http_code}' -X POST http://localhost:${GATEWAY_PORT}/v1/chat/completions -H 'Authorization: Bearer sk-test-key-1' -H 'Content-Type: application/json' -d '{\"model\":\"vllm-local\",\"messages\":[{\"role\":\"user\",\"content\":\"Hi\"}]}'"
check_body_contains "IT-01c gateway stream proxy" "data: \\[DONE\\]" "curl -sN -X POST http://localhost:${GATEWAY_PORT}/v1/chat/completions -H 'Authorization: Bearer sk-test-key-1' -H 'Content-Type: application/json' -d '{\"model\":\"vllm-local\",\"messages\":[{\"role\":\"user\",\"content\":\"Hi stream\"}],\"stream\":true}'"
check_body_contains "IT-01d gateway request id" "x-request-id: req_smoke_gateway_1" "curl -sD - -o /dev/null -X POST http://localhost:${GATEWAY_PORT}/v1/chat/completions -H 'Authorization: Bearer sk-test-key-1' -H 'X-Request-ID: req_smoke_gateway_1' -H 'Content-Type: application/json' -d '{\"model\":\"vllm-local\",\"messages\":[{\"role\":\"user\",\"content\":\"Hi request id\"}]}' | tr '[:upper:]' '[:lower:]'"
check_body_contains "IT-01e gateway cache bypass header" "x-cache: bypass" "curl -sD - -o /dev/null -X POST http://localhost:${GATEWAY_PORT}/v1/chat/completions -H 'Authorization: Bearer sk-test-key-1' -H 'Content-Type: application/json' -d '{\"model\":\"vllm-local\",\"messages\":[{\"role\":\"user\",\"content\":\"Hi cache header\"}]}' | tr '[:upper:]' '[:lower:]'"
check_body_contains "IT-01f gateway upstream model header" "x-upstream-model: vllm-local" "curl -sD - -o /dev/null -X POST http://localhost:${GATEWAY_PORT}/v1/chat/completions -H 'Authorization: Bearer sk-test-key-1' -H 'Content-Type: application/json' -d '{\"model\":\"vllm-local\",\"messages\":[{\"role\":\"user\",\"content\":\"Hi upstream header\"}]}' | tr '[:upper:]' '[:lower:]'"
...
check_code "IT-06 unknown model" "404" "curl -s -o /dev/null -w '%{http_code}' -X POST http://localhost:${GATEWAY_PORT}/v1/chat/completions -H 'Authorization: Bearer sk-test-key-1' -H 'Content-Type: application/json' -d '{\"model\":\"unknown-model\",\"messages\":[{\"role\":\"user\",\"content\":\"Hi\"}]}'"
