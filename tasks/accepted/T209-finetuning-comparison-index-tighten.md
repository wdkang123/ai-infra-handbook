Task ID: T209
Task Title: 收紧 finetuning comparison-index v1 的来源列和措辞
Owner: MINIMAX
Status: REVIEW_PENDING

Input Summary:
基于 T199 初稿和 T199-review 修订。只补齐"与本项目关系"来源列，并改弱 Unsloth 的性能数字措辞。不重写整份。
...
| **Unsloth** | 微调加速层，通过自研 CUDA kernel 加速 LoRA/QLoRA 训练阶段，底层依赖 PEFT/TRL/PyTorch | https://github.com/unslothai/unsloth |
...
| 对象 | 与本项目关系 | 来源 |
|------|------------|------|
| **LoRA** | finetune-demo 模块的核心微调路径之一 | https://github.com/unslothai/unsloth |
| **QLoRA** | finetune-demo 模块的可选路径，适合低显存场景 | https://arxiv.org/abs/2305.14314 |
| **PEFT** | finetune-demo 的微调接口层，本项目通过 PEFT API 调用 LoRA/QLoRA | https://github.com/huggingface/peft |
| **Unsloth** | finetune-demo 的可选加速层，通过 PEFT 接口集成，不改变上层 API | https://github.com/unslothai/unsloth |
