...
Input Summary:
基于 T204/T307，产出 observability comparison-index v1，比较 OpenTelemetry、Langfuse、Phoenix、TensorZero、Grafana/Prometheus 五个对象。

Result:

# Observability Comparison Index v1
...
- inference-service 中实际使用的可观测性工具选型（以实际实现为准）
