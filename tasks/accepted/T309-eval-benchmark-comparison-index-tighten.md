Task ID: T309
Task Title: 收紧 evaluation / benchmark comparison-index v1 的来源列和拼写
Owner: MINIMAX
Status: REVIEW_PENDING

Input Summary:
基于 T308 初稿和 T308-review 修订。只补齐"与本项目关系"来源列，并修正 MBBP→MBPP 拼写。不重写整份。
...
| **BigCode Eval Harness** | 评测代码模型的 HumanEval、MBPP 等任务 | https://github.com/bigcode-project/bigcode-eval-harness |
...
| 对象 | 与本项目关系 | 来源 |
|------|------------|------|
| **LM-Eval Harness** | eval-module 评测工具的首选，可与 vLLM backend 对接 | https://github.com/EleutherAI/lm-evaluation-harness |
| **Stanford HELM** | 作为全面评测框架参考，了解评测维度设计 | https://crfm.stanford.edu/helm/ |
| **BigCode Eval Harness** | 若涉及代码模型评测，可作为专用工具 | https://github.com/bigcode-project/bigcode-eval-harness |
| **LMSYS Chatbot Arena** | 作为模型选型的参考排名，不直接集成 | https://chat.lmsys.org/ |
| **Open LLM Leaderboard** | 作为模型基础能力选型的参考，不直接集成 | https://huggingface.co/spaces/open-llm-leaderboard/open_llm_leaderboard |
