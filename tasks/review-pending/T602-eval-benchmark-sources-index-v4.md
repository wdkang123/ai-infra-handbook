...
Input Summary:
收紧 evaluation/benchmark/leaderboard/arena 的边界与稳定入口。

Result:

# Eval/Benchmark Sources Index v4
...
| **稳定入口** | https://github.com/EleutherAI/lm-evaluation-harness#lm-eval-harness |
...
## 边界说明：Leaderboard vs Arena vs Benchmark

| 类型 | 本质 | 与本项目关系 |
|------|------|------------|
| **Benchmark** | 标准化测试题，产出分数 | eval-module 执行 |
| **Leaderboard** | 静态分数汇总排行 | 评测结果可提交 |
| **Arena** | 对战 + Elo 排名 | 本项目不建设，但可对接 |
