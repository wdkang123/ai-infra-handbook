...
Input Summary:
基于 T303/T205，说明 LM-Eval Harness、Stanford HELM、BigCode Eval Harness 与 eval-module 的可能关系。

Result:

# Eval Module Tooling Notes v1

## 概述

本文档说明 eval-module 与三个主要评测工具（LM-Eval Harness、Stanford HELM、BigCode Eval Harness）的可能关系，为工具选型提供参考，不输出最终实现结论。
...
| 数据集覆盖 | MMLU、GSM8K 等 70+ | 50+ 场景 | HumanEval、MBPP |
